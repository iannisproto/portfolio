...
<div class="main">
    <table class="performance-table">
        <tbody>
            <tr>
                ...
                <td class="performance-date" style="padding: 0;"><h2 style="margin: 0;">25/09-2023</h2></td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="performance-table">
        <tbody>
            <tr>
                ...
                <td class="performance-date" style="padding: 0;"><h2 style="margin: 0;">26/10-2023</h2></td>
            </tr>
        </tbody>
    </table>
    ...
    <div style="margin-top: 20px;">
        <p>Directed by Fabio Biondi in the Grand Theatre of the City of Luxembourg.</p>
        <hr class="divider"/>
        <p>
            I had a great time going to these concerts. It started off with Rossini's overture, a charming prelude which I absolutely love and went on to the Temporale. The intensity and passion of the orchestra was stunning. I think the opera as a whole is extremely catchy and memorable. I particularly enjoyed the wide variety of orchestral instruments which all contribute to make it sound very layered and well made. It’s also very familiar to me, because it's so popular and iconic.
        </p>
    ...
    <table class="performance-table">
        <tbody>
            <tr>
                <td style="padding: 0;"><h2 style="margin: 0;">Schwanensee</h2></td>
                <td class="performance-date" style="padding: 0;"><h2 style="margin: 0;">26/10-2023</h2></td>
            </tr>
        </tbody>
    </table>
    ...
    <div style="margin-top: 20px;">
        <p>Performed in TRIFOLION Echternach.</p>
        <hr class="divider"/>
        <p>
